...
def firstGUI():
    ...
    priminstr[
        "text"
    ] = """This program will create a harmonograph
...
def harmonograph(
    f1, p1, a1, f2, p2, a2, f3, p3, a3, f4, p4, a4, f5, p5, a5, f6, p6, a6
):
    wn = turtle.Screen()
    wn.bgcolor("darkcyan")
    ...
    ronald.up()
    ronald.goto(
        Pendulum1(0) + Pendulum2(0) + Pendulum3(0),
        Pendulum4(0) + Pendulum5(0) + Pendulum6(0),
    )
    ronald.down()
    print(
        "Pendulum 1 has a frequency "
        + str(f1)
        + ", a phase "
        + str(p1)
        + ", and an amplitude "
